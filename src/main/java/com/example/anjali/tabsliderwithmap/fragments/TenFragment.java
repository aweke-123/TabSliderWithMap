...
public class TenFragment extends SupportMapFragment implements
        OnMapReadyCallback {
    ...
    private void setUpMap() {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(HAMBURG, 140));

        mMap.animateCamera(CameraUpdateFactory.zoomTo(140), 2000, null);
    }
